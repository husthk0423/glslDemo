...
define(['exports', './Cartesian3-5587e0cf', './Cartesian2-b941a975', './Check-0f680516', './defined-a5305fd6', './Math-79d70b44'], (function (exports, Cartesian3, Cartesian2, Check, defined, Math$1) { 'use strict';
  ...
  const scratchCart1 = new Cartesian3.Cartesian3();
  const scratchCart2 = new Cartesian3.Cartesian3();

  function computeProperties(ellipsoidRhumbLine, start, end, ellipsoid) {
    const firstCartesian = Cartesian3.Cartesian3.normalize(
      ellipsoid.cartographicToCartesian(start, scratchCart2),
      scratchCart1
    );
    const lastCartesian = Cartesian3.Cartesian3.normalize(
    ...
    Check.Check.typeOf.number.greaterThanOrEquals(
      "value",
      Math.abs(
        Math.abs(Cartesian3.Cartesian3.angleBetween(firstCartesian, lastCartesian)) - Math.PI
      ),
      0.0125
    );
    //>>includeEnd('debug');
  ...
  function EllipsoidRhumbLine(start, end, ellipsoid) {
    const e = defined.defaultValue(ellipsoid, Cartesian2.Ellipsoid.WGS84);
    this._ellipsoid = e;
  ...
  EllipsoidRhumbLine.fromStartHeadingDistance = function (
    ...
    if (
      ...
      (defined.defined(ellipsoid) && !ellipsoid.equals(result.ellipsoid))
    ) {
...
//# sourceMappingURL=EllipsoidRhumbLine-90229f69.js.map
