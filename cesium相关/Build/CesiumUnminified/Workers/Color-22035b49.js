...
define(['exports', './Check-0f680516', './defined-a5305fd6', './Transforms-e81b498a', './Math-79d70b44'], (function (exports, Check, defined, Transforms, Math$1) { 'use strict';
  ...
  function Color(red, green, blue, alpha) {
     ...
     * @default 1.0
     */
    this.red = defined.defaultValue(red, 1.0);
    /**
     * The green component.
     * @type {Number}
     * @default 1.0
     */
    this.green = defined.defaultValue(green, 1.0);
    /**
     * The blue component.
     * @type {Number}
     * @default 1.0
     */
    this.blue = defined.defaultValue(blue, 1.0);
    /**
     * The alpha component.
     * @type {Number}
     * @default 1.0
     */
    this.alpha = defined.defaultValue(alpha, 1.0);
  }
  ...
  Color.fromBytes = function (red, green, blue, alpha, result) {
    red = Color.byteToFloat(defined.defaultValue(red, 255.0));
    green = Color.byteToFloat(defined.defaultValue(green, 255.0));
    blue = Color.byteToFloat(defined.defaultValue(blue, 255.0));
    alpha = Color.byteToFloat(defined.defaultValue(alpha, 255.0));
  ...
  Color.fromHsl = function (hue, saturation, lightness, alpha, result) {
    hue = defined.defaultValue(hue, 0.0) % 1.0;
    saturation = defined.defaultValue(saturation, 0.0);
    lightness = defined.defaultValue(lightness, 0.0);
  ...
  Color.fromRandom = function (options, result) {
    ...
    if (!defined.defined(red)) {
      const minimumRed = defined.defaultValue(options.minimumRed, 0);
      const maximumRed = defined.defaultValue(options.maximumRed, 1.0);
    ...
    if (!defined.defined(green)) {
      const minimumGreen = defined.defaultValue(options.minimumGreen, 0);
      const maximumGreen = defined.defaultValue(options.maximumGreen, 1.0);
    ...
    if (!defined.defined(blue)) {
      const minimumBlue = defined.defaultValue(options.minimumBlue, 0);
      const maximumBlue = defined.defaultValue(options.maximumBlue, 1.0);
    ...
    if (!defined.defined(alpha)) {
      const minimumAlpha = defined.defaultValue(options.minimumAlpha, 0);
      const maximumAlpha = defined.defaultValue(options.maximumAlpha, 1.0);
  ...
  Color.fromCssColorString = function (color, result) {
    ...
    if (matches !== null) {
      ...
      result.alpha = parseInt(defined.defaultValue(matches[4], "f"), 16) / 15.0;
      return result;
    }
    ...
    if (matches !== null) {
      ...
      result.alpha = parseInt(defined.defaultValue(matches[4], "ff"), 16) / 255.0;
      return result;
    }
    ...
    if (matches !== null) {
      ...
      result.alpha = parseFloat(defined.defaultValue(matches[4], "1.0"));
      return result;
    }
    ...
    if (matches !== null) {
      return Color.fromHsl(
        ...
        parseFloat(defined.defaultValue(matches[4], "1.0")),
        result
      );
    }
...
//# sourceMappingURL=Color-22035b49.js.map
