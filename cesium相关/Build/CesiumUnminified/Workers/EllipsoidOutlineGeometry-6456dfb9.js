...
define(['exports', './Transforms-e81b498a', './Cartesian3-5587e0cf', './ComponentDatatype-4ab1a86a', './defined-a5305fd6', './Check-0f680516', './Cartesian2-b941a975', './GeometryAttribute-a065274b', './GeometryAttributes-ae79d5fa', './GeometryOffsetAttribute-102da468', './IndexDatatype-be8e0e62', './Math-79d70b44'], (function (exports, Transforms, Cartesian3, ComponentDatatype, defined, Check, Cartesian2, GeometryAttribute, GeometryAttributes, GeometryOffsetAttribute, IndexDatatype, Math$1) { 'use strict';
  ...
  function EllipsoidOutlineGeometry(options) {
    ...
    const stackPartitions = Math.round(defined.defaultValue(options.stackPartitions, 10));
    const slicePartitions = Math.round(defined.defaultValue(options.slicePartitions, 8));
    const subdivisions = Math.round(defined.defaultValue(options.subdivisions, 128));
  ...
  EllipsoidOutlineGeometry.createGeometry = function (ellipsoidGeometry) {
    ...
    const ellipsoid = Cartesian2.Ellipsoid.fromCartesian3(radii);
...
//# sourceMappingURL=EllipsoidOutlineGeometry-6456dfb9.js.map
