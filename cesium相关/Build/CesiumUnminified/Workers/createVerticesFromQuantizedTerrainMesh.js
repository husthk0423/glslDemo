...
define(['./AxisAlignedBoundingBox-1a14512c', './Cartesian2-b941a975', './Cartesian3-5587e0cf', './defined-a5305fd6', './TerrainEncoding-578da000', './IndexDatatype-be8e0e62', './Math-79d70b44', './Matrix2-81068516', './Check-0f680516', './Transforms-e81b498a', './WebMercatorProjection-7ce9285b', './createTaskProcessorWorker', './AttributeCompression-59630bdd', './ComponentDatatype-4ab1a86a', './WebGLConstants-d81b330d', './RuntimeError-8d8b6ef6', './GeographicProjection-bcd5d069', './Resource-0c25a925', './_commonjsHelpers-89c9b271', './combine-eceb7722', './defer-bfc6471e'], (function (AxisAlignedBoundingBox, Cartesian2, Cartesian3, defined, TerrainEncoding, IndexDatatype, Math$1, Matrix2, Check, Transforms, WebMercatorProjection, createTaskProcessorWorker, AttributeCompression, ComponentDatatype, WebGLConstants, RuntimeError, GeographicProjection, Resource, _commonjsHelpers, combine, defer) { 'use strict';
  ...
  TerrainProvider.getRegularGridIndicesAndEdgeIndices = function (width, height) {
    ...
    if (!defined.defined(indicesAndEdges)) {
  ...
  const scratchMinimum = new Cartesian3.Cartesian3();
  const scratchMaximum = new Cartesian3.Cartesian3();
  const cartographicScratch = new Cartesian2.Cartographic();
  const toPack = new Cartesian2.Cartesian2();
  ...
  function createVerticesFromQuantizedTerrainMesh(
    ...
    const rectangle = Cartesian2.Rectangle.clone(parameters.rectangle);
    ...
    const hasVertexNormals = defined.defined(octEncodedNormals);
