...
define(['./AttributeCompression-59630bdd', './Transforms-e81b498a', './Cartesian2-b941a975', './Cartesian3-5587e0cf', './defined-a5305fd6', './TerrainEncoding-578da000', './IndexDatatype-be8e0e62', './Check-0f680516', './Math-79d70b44', './OrientedBoundingBox-c4615547', './createTaskProcessorWorker', './ComponentDatatype-4ab1a86a', './WebGLConstants-d81b330d', './Matrix2-81068516', './RuntimeError-8d8b6ef6', './GeographicProjection-bcd5d069', './Resource-0c25a925', './_commonjsHelpers-89c9b271', './combine-eceb7722', './defer-bfc6471e', './EllipsoidTangentPlane-fc899479', './AxisAlignedBoundingBox-1a14512c', './IntersectionTests-8d40a746', './Plane-20e816c1'], (function (AttributeCompression, Transforms, Cartesian2, Cartesian3, defined, TerrainEncoding, IndexDatatype, Check, Math$1, OrientedBoundingBox, createTaskProcessorWorker, ComponentDatatype, WebGLConstants, Matrix2, RuntimeError, GeographicProjection, Resource, _commonjsHelpers, combine, defer, EllipsoidTangentPlane, AxisAlignedBoundingBox, IntersectionTests, Plane) { 'use strict';
  ...
  const cartographicScratch = new Cartesian2.Cartographic();
  let cartesian3Scratch = new Cartesian3.Cartesian3();
  const uScratch = [];
  const vScratch = [];
  const heightScratch = [];
  const indicesScratch = [];
  const normalsScratch = [];
  const horizonOcclusionPointScratch = new Cartesian3.Cartesian3();
  ...
  const decodeTexCoordsScratch = new Cartesian2.Cartesian2();
  const octEncodedNormalScratch = new Cartesian3.Cartesian3();
  ...
  function upsampleQuantizedTerrainMesh(parameters, transferableObjects) {
    ...
    const ellipsoid = Cartesian2.Ellipsoid.clone(parameters.ellipsoid);
    const rectangle = Cartesian2.Rectangle.clone(parameters.childRectangle);
  ...
  let encodedScratch = new Cartesian2.Cartesian2();
  ...
  let depth = -1;
  const cartesianScratch1 = [new Cartesian3.Cartesian3(), new Cartesian3.Cartesian3()];
  const cartesianScratch2 = [new Cartesian3.Cartesian3(), new Cartesian3.Cartesian3()];
  function lerpOctEncodedNormal(vertex, result) {
    ...
    cartesian3Scratch = Cartesian3.Cartesian3.lerp(
      first,
      second,
      vertex.ratio,
      cartesian3Scratch
