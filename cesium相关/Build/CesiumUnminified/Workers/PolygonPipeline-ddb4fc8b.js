...
define(['exports', './Cartesian2-b941a975', './Cartesian3-5587e0cf', './Check-0f680516', './ComponentDatatype-4ab1a86a', './defined-a5305fd6', './EllipsoidRhumbLine-90229f69', './GeometryAttribute-a065274b', './Math-79d70b44', './WebGLConstants-d81b330d'], (function (exports, Cartesian2, Cartesian3, Check, ComponentDatatype, defined, EllipsoidRhumbLine, GeometryAttribute, Math$1, WebGLConstants) { 'use strict';
    ...
    const scaleToGeodeticHeightN = new Cartesian3.Cartesian3();
    const scaleToGeodeticHeightP = new Cartesian3.Cartesian3();
    ...
    PolygonPipeline.triangulate = function (positions, holes) {
      ...
      const flattenedPositions = Cartesian2.Cartesian2.packArray(positions);
      return earcut_1(flattenedPositions, holes, 2);
    };

    const subdivisionV0Scratch = new Cartesian3.Cartesian3();
    const subdivisionV1Scratch = new Cartesian3.Cartesian3();
    const subdivisionV2Scratch = new Cartesian3.Cartesian3();
    const subdivisionS0Scratch = new Cartesian3.Cartesian3();
    const subdivisionS1Scratch = new Cartesian3.Cartesian3();
    const subdivisionS2Scratch = new Cartesian3.Cartesian3();
    const subdivisionMidScratch = new Cartesian3.Cartesian3();
    const subdivisionT0Scratch = new Cartesian2.Cartesian2();
    const subdivisionT1Scratch = new Cartesian2.Cartesian2();
    const subdivisionT2Scratch = new Cartesian2.Cartesian2();
    const subdivisionTexcoordMidScratch = new Cartesian2.Cartesian2();
    ...
    PolygonPipeline.computeSubdivision = function (
      ...
      granularity = defined.defaultValue(granularity, Math$1.CesiumMath.RADIANS_PER_DEGREE);

      const hasTexcoords = defined.defined(texcoords);
      ...
      while (triangles.length > 0) {
        ...
        const v0 = Cartesian3.Cartesian3.fromArray(
          subdividedPositions,
          i0 * 3,
          subdivisionV0Scratch
        );
        const v1 = Cartesian3.Cartesian3.fromArray(
          subdividedPositions,
          i1 * 3,
          subdivisionV1Scratch
        );
        const v2 = Cartesian3.Cartesian3.fromArray(
          subdividedPositions,
          i2 * 3,
        ...
        let t0, t1, t2;
        if (hasTexcoords) {
          t0 = Cartesian2.Cartesian2.fromArray(
            subdividedTexcoords,
            i0 * 2,
            subdivisionT0Scratch
          );
          t1 = Cartesian2.Cartesian2.fromArray(
            subdividedTexcoords,
            i1 * 2,
            subdivisionT1Scratch
          );
          t2 = Cartesian2.Cartesian2.fromArray(
            subdividedTexcoords,
            i2 * 2,
        ...
        const s0 = Cartesian3.Cartesian3.multiplyByScalar(
          Cartesian3.Cartesian3.normalize(v0, subdivisionS0Scratch),
          radius,
          subdivisionS0Scratch
        );
        const s1 = Cartesian3.Cartesian3.multiplyByScalar(
          Cartesian3.Cartesian3.normalize(v1, subdivisionS1Scratch),
          radius,
          subdivisionS1Scratch
        );
        const s2 = Cartesian3.Cartesian3.multiplyByScalar(
          Cartesian3.Cartesian3.normalize(v2, subdivisionS2Scratch),
          radius,
          subdivisionS2Scratch
        );

        const g0 = Cartesian3.Cartesian3.magnitudeSquared(
          Cartesian3.Cartesian3.subtract(s0, s1, subdivisionMidScratch)
        );
        const g1 = Cartesian3.Cartesian3.magnitudeSquared(
          Cartesian3.Cartesian3.subtract(s1, s2, subdivisionMidScratch)
        );
        const g2 = Cartesian3.Cartesian3.magnitudeSquared(
          Cartesian3.Cartesian3.subtract(s2, s0, subdivisionMidScratch)
        );
        ...
        if (max > minDistanceSqrd) {
          if (g0 === max) {
            ...
            if (!defined.defined(i)) {
              ...
              if (hasTexcoords) {
                midTexcoord = Cartesian2.Cartesian2.add(t0, t1, subdivisionTexcoordMidScratch);
                Cartesian2.Cartesian2.multiplyByScalar(midTexcoord, 0.5, midTexcoord);
            ...
            if (!defined.defined(i)) {
              ...
              if (hasTexcoords) {
                midTexcoord = Cartesian2.Cartesian2.add(t1, t2, subdivisionTexcoordMidScratch);
                Cartesian2.Cartesian2.multiplyByScalar(midTexcoord, 0.5, midTexcoord);
                subdividedTexcoords.push(midTexcoord.x, midTexcoord.y);
              }
            }
            ...
            if (!defined.defined(i)) {
              ...
              if (hasTexcoords) {
                midTexcoord = Cartesian2.Cartesian2.add(t2, t0, subdivisionTexcoordMidScratch);
                Cartesian2.Cartesian2.multiplyByScalar(midTexcoord, 0.5, midTexcoord);
                subdividedTexcoords.push(midTexcoord.x, midTexcoord.y);
              }
            }
    ...
    const subdivisionC0Scratch = new Cartesian2.Cartographic();
    const subdivisionC1Scratch = new Cartesian2.Cartographic();
    const subdivisionC2Scratch = new Cartesian2.Cartographic();
    const subdivisionCartographicScratch = new Cartesian2.Cartographic();
        ...
        if (max > minDistance) {
          if (g0 === max) {
            ...
            if (!defined.defined(i)) {
              ...
              midCartesian3 = Cartesian3.Cartesian3.fromRadians(
                mid.longitude,
                mid.latitude,
                midHeight,
                ellipsoid,
    ...
    PolygonPipeline.scaleToGeodeticHeight = function (
      ...
      scaleToSurface = defined.defaultValue(scaleToSurface, true);
...
//# sourceMappingURL=PolygonPipeline-ddb4fc8b.js.map
