...
define(['./AttributeCompression-59630bdd', './Cartesian3-5587e0cf', './Cartesian2-b941a975', './Color-22035b49', './defined-a5305fd6', './IndexDatatype-be8e0e62', './Math-79d70b44', './OrientedBoundingBox-c4615547', './createTaskProcessorWorker', './ComponentDatatype-4ab1a86a', './Check-0f680516', './WebGLConstants-d81b330d', './Matrix2-81068516', './RuntimeError-8d8b6ef6', './Transforms-e81b498a', './GeographicProjection-bcd5d069', './Resource-0c25a925', './_commonjsHelpers-89c9b271', './combine-eceb7722', './defer-bfc6471e', './EllipsoidTangentPlane-fc899479', './AxisAlignedBoundingBox-1a14512c', './IntersectionTests-8d40a746', './Plane-20e816c1'], (function (AttributeCompression, Cartesian3, Cartesian2, Color, defined, IndexDatatype, Math$1, OrientedBoundingBox, createTaskProcessorWorker, ComponentDatatype, Check, WebGLConstants, Matrix2, RuntimeError, Transforms, GeographicProjection, Resource, _commonjsHelpers, combine, defer, EllipsoidTangentPlane, AxisAlignedBoundingBox, IntersectionTests, Plane) { 'use strict';
  ...
  const scratchScaledNormal = new Cartesian3.Cartesian3();
  const scratchMinHeightPosition = new Cartesian3.Cartesian3();
  const scratchMaxHeightPosition = new Cartesian3.Cartesian3();
  const scratchBVCartographic = new Cartesian2.Cartographic();
  const scratchBVRectangle = new Cartesian2.Rectangle();
  ...
  function createVectorTilePolygons(parameters, transferableObjects) {
    ...
    for (i = 0; i < positionsLength; ++i) {
      ...
      const cart = Cartesian2.Cartographic.fromRadians(x, y, 0.0, scratchBVCartographic);
    ...
    for (i = 0; i < countsLength; ++i) {
      ...
      for (j = 0; j < polygonCount; ++j) {
        const position = Cartesian3.Cartesian3.unpack(
          decodedPositions,
          polygonOffset * 3 + j * 3,
          scratchEncodedPosition
        );
        ...
        const minHeightPosition = Cartesian3.Cartesian3.add(
          position,
          scaledNormal,
        ...
        const maxHeightPosition = Cartesian3.Cartesian3.add(
          position,
          scaledNormal,
