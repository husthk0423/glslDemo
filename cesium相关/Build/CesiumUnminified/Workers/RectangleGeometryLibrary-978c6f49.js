...
define(['exports', './Cartesian3-5587e0cf', './Cartesian2-b941a975', './defined-a5305fd6', './Check-0f680516', './GeographicProjection-bcd5d069', './Math-79d70b44', './Matrix2-81068516'], (function (exports, Cartesian3, Cartesian2, defined, Check, GeographicProjection, Math$1, Matrix2) { 'use strict';
  ...
  let nwCartesian = new Cartesian3.Cartesian3();
  const centerScratch = new Cartesian2.Cartographic();
  let centerCartesian = new Cartesian3.Cartesian3();
  const proj = new GeographicProjection.GeographicProjection();
  ...
  RectangleGeometryLibrary.computeOptions = function (
    ...
    const nwCorner = Cartesian2.Rectangle.northwest(rectangle, nwCornerResult);
    ...
    const boundingRectangle = Cartesian2.Rectangle.clone(
      rectangle,
      boundingRectangleScratch
    );
    ...
    if (stRotation !== 0) {
      ...
      const stNwCorner = Cartesian2.Rectangle.northwest(boundingRectangle, stNwCornerResult);
...
//# sourceMappingURL=RectangleGeometryLibrary-978c6f49.js.map
