...
define((function () { 'use strict';
     ...
     * @private
     */
        function ModelPointDrawer(layerDataMapArr,level,featureMap,control,highLighStr,filterLayerId){
        ...
        ModelPointDrawer.prototype.getBackgroundDrawer = function(){
            this.vectorDatas = [];
            return this;
        };

        ModelPointDrawer.prototype.getBackground = function(){
            this.vectorDatas = [];
            return this;
        };

        ModelPointDrawer.prototype.getTypeString = function(type){
        ...
        ModelPointDrawer.prototype.getScatterDrawer = function(dataLayerID,styleLayerID){
            this.index++;
            this.vectorDatas = [];
        ...
        ModelPointDrawer.prototype.getLayer = function(dataLayerID,styleLayerID){
            this.index++;
            this.vectorDatas = [];
            // if(this.filterLayerId && dataLayerID !=this.filterLayerId){
            //     return this;
        ...
        ModelPointDrawer.prototype.getGroupLayer = function(dataLayerID,value,styleLayerID){
            this.index++;
            this.vectorDatas = [];
        ...
        ModelPointDrawer.prototype.setStyle = function(fn){
        ...
        ModelPointDrawer.prototype.getFieldValueMap = function(data,vectorData){
            let  fieldValueMap=  {};
        ...
        ModelPointDrawer.prototype.draw = function(){
        };

        ModelPointDrawer.prototype._getProperty = function(data){
            return data[1];
        };

        ModelPointDrawer.prototype._getPoints = function(data){
            return data[2];
        };
        ModelPointDrawer.prototype._getType = function(data){
            return data[0];
        };
        ModelPointDrawer.prototype._filterByStyle = function(gjson,styleLayerID){
            this._getType(gjson);
        ...
        ModelPointDrawer.prototype._highLightByStyle = function(gjson,styleLayerID){
            this._getType(gjson);
            let points = this._getPoints(gjson);
            this._getProperty(gjson);
            if(points == null){
    ...
    return ModelPointDrawer;

}));
//# sourceMappingURL=ModelPointDrawer.js.map
