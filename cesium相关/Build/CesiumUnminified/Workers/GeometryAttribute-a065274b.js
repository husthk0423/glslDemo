...
define(['exports', './Cartesian2-b941a975', './Cartesian3-5587e0cf', './Check-0f680516', './defined-a5305fd6', './Matrix2-81068516', './WebGLConstants-d81b330d', './Transforms-e81b498a'], (function (exports, Cartesian2, Cartesian3, Check, defined, Matrix2, WebGLConstants, Transforms) { 'use strict';
  ...
  function Geometry(options) {
     ...
     * @default undefined
     */
    this.primitiveType = defined.defaultValue(
     ...
     * @private
     */
    this.geometryType = defined.defaultValue(options.geometryType, GeometryType$1.NONE);
  ...
  const enuCenterScratch = new Cartesian3.Cartesian3();
  ...
  const pointEnuScratch = new Cartesian3.Cartesian3();
  ...
  Geometry._textureCoordinateRotationPoints = function (
    ...
    const rectangleCenter = Cartesian2.Rectangle.center(
      boundingRectangle,
      rectangleCenterScratch
    );
    const enuCenter = Cartesian2.Cartographic.toCartesian(
      rectangleCenter,
      ellipsoid,
      enuCenterScratch
    );
...
//# sourceMappingURL=GeometryAttribute-a065274b.js.map
