...
let measureLineSpace = (viewer, handler,obj) =>{
    // 取消双击事件-追踪该位置
    ...
    handler.setInputAction(function(movement) {
        ...
        tooltip.innerHTML = '<span style="color: #fff; font-size: 14px">单击开始，双击结束</span>';
...
let measureAreaSpace = (viewer, handler,obj) =>{
    // 取消双击事件-追踪该位置
    viewer.cesiumWidget.screenSpaceEventHandler.removeInputAction(
        Cesium.ScreenSpaceEventType.LEFT_DOUBLE_CLICK
    );
