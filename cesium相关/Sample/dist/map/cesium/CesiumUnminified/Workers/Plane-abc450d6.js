...
define(['exports', './Cartesian2-d1e6e2fc', './Matrix4-e8df88c4', './Check-edea0f91', './defaultValue-81eec7ed', './Math-6392bd21'], (function (exports, Cartesian2, Matrix4, Check, defaultValue, _Math) { 'use strict';
  ...
  var scratchInverseTranspose = new Matrix4.Matrix4();
  var scratchPlaneCartesian4 = new Matrix4.Cartesian4();
  ...
  Plane.transform = function (plane, transform, result) {
    ...
    var inverseTranspose = Matrix4.Matrix4.inverseTranspose(
      transform,
      scratchInverseTranspose
    );
    var planeAsCartesian4 = Matrix4.Cartesian4.fromElements(
      normal.x,
      normal.y,
      normal.z,
      distance,
    ...
    planeAsCartesian4 = Matrix4.Matrix4.multiplyByVector(
      inverseTranspose,
      planeAsCartesian4,
      planeAsCartesian4
    );
    ...
    planeAsCartesian4 = Matrix4.Cartesian4.divideByScalar(
      planeAsCartesian4,
...
//# sourceMappingURL=Plane-abc450d6.js.map
