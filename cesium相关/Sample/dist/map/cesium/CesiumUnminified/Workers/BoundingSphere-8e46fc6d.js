...
define(['exports', './Cartesian2-30a7929d', './Check-1d0ca1d6', './defaultValue-e27640a4', './GeographicProjection-ad0e20b7', './Math-dc70d5e5', './Transforms-8def6431', './Rectangle-1cb0613d'], (function (exports, Cartesian2, Check, defaultValue, GeographicProjection, _Math, Transforms, Rectangle) { 'use strict';
    ...
    /**
        ...
        var defaultProjection = new GeographicProjection.GeographicProjection();
        ...
        BoundingSphere.fromEncodedCartesianVertices = function(positionsHigh, positionsLow, result) {
            ...
            if (!defaultValue.defined(positionsHigh) || !defaultValue.defined(positionsLow) || positionsHigh.length !== positionsLow.length || positionsHigh.length === 0) {
                result.center = Cartesian2.Cartesian3.clone(Cartesian2.Cartesian3.ZERO, result.center);
                result.radius = 0.0;
                return result;
            }
        ...
        BoundingSphere.fromOrientedBoundingBox = function(orientedBoundingBox, result) {
            ...
            var u = Transforms.Matrix3.getColumn(halfAxes, 0, fromOrientedBoundingBoxScratchU);
            var v = Transforms.Matrix3.getColumn(halfAxes, 1, fromOrientedBoundingBoxScratchV);
            var w = Transforms.Matrix3.getColumn(halfAxes, 2, fromOrientedBoundingBoxScratchW);
        ...
        BoundingSphere.transform = function(sphere, transform, result) {
            ...
            result.center = Transforms.Matrix4.multiplyByPoint(transform, sphere.center, result.center);
            result.radius = Transforms.Matrix4.getMaximumScale(transform) * sphere.radius;
        ...
        var projectTo2DProjection = new GeographicProjection.GeographicProjection();
        /**
...
//# sourceMappingURL=BoundingSphere-8e46fc6d.js.map
