...
define(['exports', './BoundingSphere-8e46fc6d', './Cartesian2-30a7929d', './Check-1d0ca1d6', './defaultValue-e27640a4', './Rectangle-1cb0613d', './AttributeCompression-4bb16961', './ComponentDatatype-c3776840', './Math-dc70d5e5', './Transforms-8def6431'], (function (exports, BoundingSphere, Cartesian2, Check, defaultValue, Rectangle, AttributeCompression, ComponentDatatype, _Math, Transforms) { 'use strict';
    ...
    /**
        ...
        EllipsoidalOccluder.prototype.isScaledSpacePointVisiblePossiblyUnderEllipsoid = function(occludeeScaledSpacePosition, minimumHeight) {
            ...
            if (defaultValue.defined(minimumHeight) && minimumHeight < 0.0 && ellipsoid.minimumRadius > -minimumHeight) {
    ...
    var cartesian3Scratch = new Cartesian2.Cartesian3();
        ...
        function TerrainEncoding(axisAlignedBoundingBox, minimumHeight, maximumHeight, fromENU, hasVertexNormals, hasWebMercatorT) {
            ...
            if (defaultValue.defined(axisAlignedBoundingBox) && defaultValue.defined(minimumHeight) && defaultValue.defined(maximumHeight) && defaultValue.defined(fromENU)) {
...
//# sourceMappingURL=TerrainEncoding-822c0f70.js.map
