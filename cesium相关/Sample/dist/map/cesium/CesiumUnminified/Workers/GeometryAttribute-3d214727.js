...
define(['exports', './Cartesian2-d1e6e2fc', './Check-edea0f91', './defaultValue-81eec7ed', './Matrix2-e81eda7e', './Matrix4-e8df88c4', './WebGLConstants-1c8239cc', './Transforms-bfe0c1cb', './Rectangle-56d45148'], (function (exports, Cartesian2, Check, defaultValue, Matrix2, Matrix4, WebGLConstants, Transforms, Rectangle) { 'use strict';
  ...
  Geometry._textureCoordinateRotationPoints = function (
    ...
    var rectangleCenter = Rectangle.Rectangle.center(
      boundingRectangle,
    ...
    var fixedFrameToEnu = Matrix4.Matrix4.inverse(
      enuToFixedFrame,
      fixedFrameToEnuScratch
    );
    ...
    for (i = 0; i < positionsLength; i++) {
      posEnu = Matrix4.Matrix4.multiplyByPointAsVector(
        fixedFrameToEnu,
        positions[i],
        posEnu
      );
...
//# sourceMappingURL=GeometryAttribute-3d214727.js.map
