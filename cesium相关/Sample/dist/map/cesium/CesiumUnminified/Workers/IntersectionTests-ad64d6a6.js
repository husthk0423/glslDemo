...
define(['exports', './Cartesian2-d1e6e2fc', './defaultValue-81eec7ed', './Check-edea0f91', './BoundingSphere-9136c54c', './Math-6392bd21', './Matrix4-e8df88c4'], (function (exports, Cartesian2, defaultValue, Check, BoundingSphere, _Math, Matrix4) { 'use strict';
  ...
  function quadraticVectorExpression(A, b, c, x, w) {
    ...
    var l1 =
      ...
      (x *
        addWithCancellationCheck(
          A[Matrix4.Matrix3.COLUMN1ROW0],
          A[Matrix4.Matrix3.COLUMN0ROW1],
          _Math.CesiumMath.EPSILON15
        ) +
        b.y);
    var l0 =
      A[Matrix4.Matrix3.COLUMN0ROW0] * xSquared +
      A[Matrix4.Matrix3.COLUMN2ROW2] * wSquared +
      x * b.x +
      c;
    ...
    var r1 =
      wSquared *
      addWithCancellationCheck(
        A[Matrix4.Matrix3.COLUMN2ROW1],
        A[Matrix4.Matrix3.COLUMN1ROW2],
        _Math.CesiumMath.EPSILON15
      );
    var r0 =
      w *
      (x *
        addWithCancellationCheck(A[Matrix4.Matrix3.COLUMN2ROW0], A[Matrix4.Matrix3.COLUMN0ROW2]) +
        b.z);
  ...
  IntersectionTests.grazingAltitudeLocation = function (ray, ellipsoid) {
    ...
    var temp = Matrix4.Matrix3.multiply(
      Matrix4.Matrix3.multiply(B_T, D, tempMatrix),
      C,
      tempMatrix
    );
    ...
    if (length > 0) {
      ...
      for (var i = 0; i < length; ++i) {
        s = Matrix4.Matrix3.multiplyByVector(
          D_I,
          Matrix4.Matrix3.multiplyByVector(B, solutions[i], sScratch),
          sScratch
        );
...
//# sourceMappingURL=IntersectionTests-ad64d6a6.js.map
