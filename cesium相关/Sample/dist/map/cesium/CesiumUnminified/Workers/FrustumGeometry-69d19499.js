...
define(['exports', './BoundingSphere-8e46fc6d', './Cartesian2-30a7929d', './Transforms-8def6431', './Check-1d0ca1d6', './ComponentDatatype-c3776840', './defaultValue-e27640a4', './GeometryAttribute-122cccb9', './GeometryAttributes-42f6198b', './Math-dc70d5e5', './Plane-29012d93', './VertexFormat-ef4e35f2'], (function (exports, BoundingSphere, Cartesian2, Transforms, Check, ComponentDatatype, defaultValue, GeometryAttribute, GeometryAttributes, _Math, Plane, VertexFormat) { 'use strict';
    ...
    /**
        ...
        function update$3(frustum) {
            //>>includeStart('debug', pragmas.debug);
            if (!defaultValue.defined(frustum.right) || !defaultValue.defined(frustum.left) ||
                !defaultValue.defined(frustum.top) || !defaultValue.defined(frustum.bottom) ||
                !defaultValue.defined(frustum.near) || !defaultValue.defined(frustum.far)) {
        ...
        OrthographicOffCenterFrustum.prototype.equals = function(other) {
            return (defaultValue.defined(other) && other instanceof OrthographicOffCenterFrustum &&
    ...
    /**
        ...
        function update$2(frustum) {
            //>>includeStart('debug', pragmas.debug);
            if (!defaultValue.defined(frustum.width) || !defaultValue.defined(frustum.aspectRatio) || !defaultValue.defined(frustum.near) || !defaultValue.defined(frustum.far)) {
    ...
    /**
        ...
        PerspectiveOffCenterFrustum.prototype.equals = function(other) {
            return (defaultValue.defined(other) && other instanceof PerspectiveOffCenterFrustum &&
                    this.right === other.right &&
                    this.left === other.left &&
                    this.top === other.top &&
                    this.bottom === other.bottom &&
    ...
    /**
        ...
        function update(frustum) {
            //>>includeStart('debug', pragmas.debug);
            if (!defaultValue.defined(frustum.fov) || !defaultValue.defined(frustum.aspectRatio) || !defaultValue.defined(frustum.near) || !defaultValue.defined(frustum.far)) {
    ...
    var PERSPECTIVE = 0;
        ...
        FrustumGeometry.createGeometry = function(frustumGeometry) {
            ...
            if (defaultValue.defined(vertexFormat.normal) || defaultValue.defined(vertexFormat.tangent) || defaultValue.defined(vertexFormat.bitangent) || defaultValue.defined(vertexFormat.st)) {
                var normals = defaultValue.defined(vertexFormat.normal) ? new Float32Array(3 * 4 * numberOfPlanes) : undefined;
                var tangents = defaultValue.defined(vertexFormat.tangent) ? new Float32Array(3 * 4 * numberOfPlanes) : undefined;
                var bitangents = defaultValue.defined(vertexFormat.bitangent) ? new Float32Array(3 * 4 * numberOfPlanes) : undefined;
                var st = defaultValue.defined(vertexFormat.st) ? new Float32Array(2 * 4 * numberOfPlanes) : undefined;
...
//# sourceMappingURL=FrustumGeometry-69d19499.js.map
