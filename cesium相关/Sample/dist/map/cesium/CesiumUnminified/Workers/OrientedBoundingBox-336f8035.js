...
define(['exports', './BoundingSphere-8e46fc6d', './Cartesian2-30a7929d', './Check-1d0ca1d6', './defaultValue-e27640a4', './EllipsoidTangentPlane-7a0466ef', './Math-dc70d5e5', './Transforms-8def6431', './Plane-29012d93', './Rectangle-1cb0613d'], (function (exports, BoundingSphere, Cartesian2, Check, defaultValue, EllipsoidTangentPlane, _Math, Transforms, Plane, Rectangle) { 'use strict';
    ...
    /**
        ...
        function fromPlaneExtents(planeOrigin, planeXAxis, planeYAxis, planeZAxis, minimumX, maximumX, minimumY, maximumY, minimumZ, maximumZ, result) {
            //>>includeStart('debug', pragmas.debug);
            if (!defaultValue.defined(minimumX) ||
        ...
        OrientedBoundingBox.fromRectangle = function(rectangle, minimumHeight, maximumHeight, ellipsoid, result) {
            ...
            if (defaultValue.defined(ellipsoid) && !_Math.CesiumMath.equalsEpsilon(ellipsoid.radii.x, ellipsoid.radii.y, _Math.CesiumMath.EPSILON15)) {
...
//# sourceMappingURL=OrientedBoundingBox-336f8035.js.map
