...
define(['exports', './AttributeCompression-4bb16961', './Cartesian2-30a7929d', './Check-1d0ca1d6', './defaultValue-e27640a4', './Math-dc70d5e5', './BoundingSphere-8e46fc6d', './Transforms-8def6431', './ComponentDatatype-c3776840', './EncodedCartesian3-6469869d', './GeographicProjection-ad0e20b7', './GeometryAttribute-122cccb9', './IndexDatatype-87e5aa85', './IntersectionTests-bb4f4361', './Plane-29012d93'], (function (exports, AttributeCompression, Cartesian2, Check, defaultValue, _Math, BoundingSphere, Transforms, ComponentDatatype, EncodedCartesian3, GeographicProjection, GeometryAttribute, IndexDatatype, IntersectionTests, Plane) { 'use strict';
    ...
    /**
        ...
        GeometryPipeline.fitToUnsignedShortIndices = function(geometry) {
            ...
            if (defaultValue.defined(geometry.indices) && (numberOfVertices >= _Math.CesiumMath.SIXTY_FOUR_KILOBYTES)) {
                var oldToNewIndex = [];
                var newIndices = [];
                var currentIndex = 0;
        ...
        GeometryPipeline.projectTo2D = function(geometry, attributeName, attributeName3D, attributeName2D, projection) {
            ...
            projection = (defaultValue.defined(projection)) ? projection : new GeographicProjection.GeographicProjection();
        ...
        GeometryPipeline.transformToWorldCoordinates = function(instance) {
            ...
            if ((defaultValue.defined(attributes.normal)) ||
            ...
            for (name in attributes0) {
                if (attributes0.hasOwnProperty(name) &&
                    ...
                    for (var i = 1; i < length; ++i) {
                        ...
                        if ((!defaultValue.defined(otherAttribute)) ||
        ...
        function combineGeometries(instances, propertyName) {
            ...
            var haveIndices = (defaultValue.defined(instances[0][propertyName].indices));
            ...
            return new GeometryAttribute.Geometry({
                ...
                boundingSphere : (defaultValue.defined(center)) ? new BoundingSphere.BoundingSphere(center, radius) : undefined
            });
        }
        ...
        GeometryPipeline.combineInstances = function(instances) {
            ...
            for (var i = 0; i < length; ++i) {
                ...
                } else if (defaultValue.defined(instance.westHemisphereGeometry) && defaultValue.defined(instance.eastHemisphereGeometry)) {
        ...
        GeometryPipeline.computeNormal = function(geometry) {
            ...
            if (!defaultValue.defined(geometry.attributes.position) || !defaultValue.defined(geometry.attributes.position.values)) {
        ...
        GeometryPipeline.compressVertices = function(geometry) {
            ...
            var hasNormal = defaultValue.defined(normalAttribute);
            var hasSt = defaultValue.defined(stAttribute);
            if (!hasNormal && !hasSt) {
                return geometry;
            }
            ...
            var hasTangent = defaultValue.defined(tangentAttribute);
            var hasBitangent = defaultValue.defined(bitangentAttribute);
        ...
        function updateInstanceAfterSplit(instance, westGeometry, eastGeometry) {
            var computeBoundingSphere = defaultValue.defined(instance.geometry.boundingSphere);
        ...
        function computeTriangleAttributes(i0, i1, i2, point, positions, normals, tangents, bitangents, texCoords, extrudeDirections, applyOffset, currentAttributes, customAttributeNames, customAttributesLength, allAttributes, insertedIndex) {
            if (!defaultValue.defined(normals) && !defaultValue.defined(tangents) && !defaultValue.defined(bitangents) && !defaultValue.defined(texCoords) && !defaultValue.defined(extrudeDirections) && customAttributesLength === 0) {
                return;
            }
        ...
        function splitLongitudeTriangles(instance) {
            ...
            var normals = (defaultValue.defined(attributes.normal)) ? attributes.normal.values : undefined;
            var bitangents = (defaultValue.defined(attributes.bitangent)) ? attributes.bitangent.values : undefined;
            var tangents = (defaultValue.defined(attributes.tangent)) ? attributes.tangent.values : undefined;
            var texCoords = (defaultValue.defined(attributes.st)) ? attributes.st.values : undefined;
            var extrudeDirections = (defaultValue.defined(attributes.extrudeDirection)) ? attributes.extrudeDirection.values : undefined;
            var applyOffset = defaultValue.defined(attributes.applyOffset) ? attributes.applyOffset.values : undefined;
            var indices = geometry.indices;

            var customAttributeNames = [];
            for (var attributeName in attributes) {
                if (attributes.hasOwnProperty(attributeName) && !NAMED_ATTRIBUTES[attributeName] && defaultValue.defined(attributes[attributeName])) {
        ...
        function splitLongitudePolyline(instance) {
            ...
            var texCoords = (defaultValue.defined(attributes.st)) ? attributes.st.values : undefined;
            var colors = (defaultValue.defined(attributes.color)) ? attributes.color.values : undefined;
...
//# sourceMappingURL=GeometryPipeline-aabfa393.js.map
