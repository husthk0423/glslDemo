...
define(['exports', './when-c305ab76', './Check-1d0ca1d6', './defaultValue-e27640a4', './RuntimeError-b7a272ee'], (function (exports, when, Check, defaultValue, RuntimeError) { 'use strict';
	...
	/**
	    ...
	    function combine(object1, object2, deep) {
	        ...
	        var object1Defined = defaultValue.defined(object1);
	        var object2Defined = defaultValue.defined(object2);
	        var property;
	        var object1Value;
	        var object2Value;
	        if (object1Defined) {
	...
	/**
	    ...
	    function getBaseUri(uri, includeQuery) {
	        ...
	        uri = new URI(uri);
	        if (defaultValue.defined(uri.query)) {
	            basePath += '?' + uri.query;
	        }
	        if (defaultValue.defined(uri.fragment)){
	...
	/**
	    ...
	    function getAuthority(url) {
	        ...
	        if (!defaultValue.defined(authority)) {
	        ...
	        if (authority.indexOf(':') === -1) {
	            ...
	            if (!defaultValue.defined(scheme)) {
	...
	var xhrBlobSupported = (function() {
	    ...
	    function parseQuery(uri, resource, merge, preserveQueryParameters) {
	        ...
	        if (!defaultValue.defined(queryString) || (queryString.length === 0)) {
	            return {};
	        }
	    ...
	    Resource._Implementations.loadWithXhr = function(url, responseType, method, data, headers, deferred, overrideMimeType) {
	        ...
	        xhr.onload = function() {
	            ...
	            if (xhr.status === 204) {
	                // accept no content
	                deferred.resolve();
	            } else if (defaultValue.defined(response) && (!defaultValue.defined(responseType) || (browserResponseType === responseType))) {
	            ...
	            } else if ((browserResponseType === '' || browserResponseType === 'document') && defaultValue.defined(xhr.responseXML) && xhr.responseXML.hasChildNodes()) {
	                deferred.resolve(xhr.responseXML);
	            } else if ((browserResponseType === '' || browserResponseType === 'text') && defaultValue.defined(xhr.responseText)) {
...
//# sourceMappingURL=Resource-194cece5.js.map
