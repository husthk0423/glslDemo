...
define(['exports', './Cartesian2-30a7929d', './defaultValue-e27640a4', './Check-1d0ca1d6', './BoundingSphere-8e46fc6d', './Math-dc70d5e5', './Transforms-8def6431'], (function (exports, Cartesian2, defaultValue, Check, BoundingSphere, _Math, Transforms) { 'use strict';
    ...
    /**
        ...
        QuadraticRealPolynomial.computeRealRoots = function(a, b, c) {
            ...
            var q = -0.5 * addWithCancellationCheck$1(b, _Math.CesiumMath.sign(b) * Math.sqrt(radicand), _Math.CesiumMath.EPSILON14);
            if (b > 0.0) {
                return [q / a, c / q];
            }
    ...
    /**
        ...
        IntersectionTests.lineSegmentTriangle = function(v0, v1, p0, p1, p2, cullBackFaces, result) {
            ...
            var t = IntersectionTests.rayTriangleParametric(ray, p0, p1, p2, cullBackFaces);
            if (!defaultValue.defined(t) || t < 0.0 || t > Cartesian2.Cartesian3.distance(v0, v1)) {
                return undefined;
            }
        ...
        function quadraticVectorExpression(A, b, c, x, w) {
            ...
            var l1 = w * (x * addWithCancellationCheck(A[Transforms.Matrix3.COLUMN1ROW0], A[Transforms.Matrix3.COLUMN0ROW1], _Math.CesiumMath.EPSILON15) + b.y);
            var l0 = (A[Transforms.Matrix3.COLUMN0ROW0] * xSquared + A[Transforms.Matrix3.COLUMN2ROW2] * wSquared) + x * b.x + c;

            var r1 = wSquared * addWithCancellationCheck(A[Transforms.Matrix3.COLUMN2ROW1], A[Transforms.Matrix3.COLUMN1ROW2], _Math.CesiumMath.EPSILON15);
            ...
            for ( var i = 0; i < length; ++i) {
                ...
                if (_Math.CesiumMath.sign(l2) === _Math.CesiumMath.sign(l0)) {
                    left = addWithCancellationCheck(l2 * cosineSquared + l0, l1 * cosine, _Math.CesiumMath.EPSILON12);
                } else if (_Math.CesiumMath.sign(l0) === _Math.CesiumMath.sign(l1 * cosine)) {
                    left = addWithCancellationCheck(l2 * cosineSquared, l1 * cosine + l0, _Math.CesiumMath.EPSILON12);
                } else {
                    left = addWithCancellationCheck(l2 * cosineSquared + l1 * cosine, l0, _Math.CesiumMath.EPSILON12);
                }
        ...
        IntersectionTests.grazingAltitudeLocation = function(ray, ellipsoid) {
            ...
            var intersects = defaultValue.defined(this.rayEllipsoid(ray, ellipsoid));
...
//# sourceMappingURL=IntersectionTests-bb4f4361.js.map
