...
define(['exports', './defaultValue-e27640a4', './Check-1d0ca1d6', './Math-9a3e4d67', './Cartesian2-7e9c39c4', './BoundingSphere-606bcc54', './Transforms-35947800', './Rectangle-79499fbe', './ComponentDatatype-c3776840', './GeometryAttribute-4583fb5d', './GeometryPipeline-fb6a49ac', './IndexDatatype-87e5aa85', './GeometryOffsetAttribute-e4614690', './VertexFormat-ef4e35f2', './GeometryInstance-e13ba6c3', './BoundingRectangle-2ae828a6', './EllipsoidTangentPlane-14231626', './ArcType-29cf2197', './PolygonPipeline-0eb56eb9', './PolygonGeometryLibrary-12a705a0', './EllipsoidGeodesic-7d332c02'], function (exports, defaultValue, Check, _Math, Cartesian2, BoundingSphere, Transforms, Rectangle, ComponentDatatype, GeometryAttribute, GeometryPipeline, IndexDatatype, GeometryOffsetAttribute, VertexFormat, GeometryInstance, BoundingRectangle, EllipsoidTangentPlane, ArcType, PolygonPipeline, PolygonGeometryLibrary, EllipsoidGeodesic) { 'use strict';
    ...
    var scratchCarto1 = new Cartesian2.Cartographic();
        ...
        function computeRectangle(positions, ellipsoid, arcType, granularity, result) {
            result = defaultValue.defaultValue(result, new Rectangle.Rectangle());
        ...
        function PolygonGeometry(options) {
            ...
            if (defaultValue.defined(options.perPositionHeight) && options.perPositionHeight && defaultValue.defined(options.height)) {
            ...
            var perPositionHeightExtrude = perPositionHeight && defaultValue.defined(options.extrudedHeight);
...
//# sourceMappingURL=PolygonGeometry-f2b8c654.js.map
