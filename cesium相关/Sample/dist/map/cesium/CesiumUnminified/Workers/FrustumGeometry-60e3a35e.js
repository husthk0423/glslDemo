...
define(['exports', './BoundingSphere-9136c54c', './Cartesian2-d1e6e2fc', './Matrix4-e8df88c4', './Check-edea0f91', './ComponentDatatype-a4840ad0', './defaultValue-81eec7ed', './GeometryAttribute-3d214727', './GeometryAttributes-32b29525', './Math-6392bd21', './Plane-abc450d6', './Transforms-bfe0c1cb', './VertexFormat-e098f487'], (function (exports, BoundingSphere, Cartesian2, Matrix4, Check, ComponentDatatype, defaultValue, GeometryAttribute, GeometryAttributes, _Math, Plane, Transforms, VertexFormat) { 'use strict';
  ...
  function update$3(frustum) {
    ...
    if (
      ...
      frustum._orthographicMatrix = Matrix4.Matrix4.computeOrthographicOffCenter(
        frustum.left,
        frustum.right,
        frustum.bottom,
        frustum.top,
  ...
  function update$1(frustum) {
    ...
    if (
      ...
      frustum._near = n;
      frustum._far = f;
      frustum._perspectiveMatrix = Matrix4.Matrix4.computePerspectiveOffCenter(
        l,
        r,
        b,
        t,
      ...
      frustum._infinitePerspective = Matrix4.Matrix4.computeInfinitePerspectiveOffCenter(
        l,
        r,
        b,
        t,
  ...
  FrustumGeometry._computeNearFarPlanes = function (
    ...
    var rotationMatrix = Matrix4.Matrix3.fromQuaternion(
      orientation,
    ...
    if (frustumType === PERSPECTIVE) {
      ...
      var viewProjection = Matrix4.Matrix4.multiply(
        projection,
        view,
        scratchInverseMatrix
      );
      inverseViewProjection = Matrix4.Matrix4.inverse(
        viewProjection,
        scratchInverseMatrix
      );
    } else {
    ...
    for (var i = 0; i < 2; ++i) {
      for (var j = 0; j < 4; ++j) {
        var corner = Matrix4.Cartesian4.clone(
          frustumCornersNDC[j],
        ...
        if (!defaultValue.defined(inverseViewProjection)) {
          ...
          corner = Matrix4.Matrix4.multiplyByVector(
  ...
  FrustumGeometry.createGeometry = function (frustumGeometry) {
    ...
    if (
      ...
      var normals = defaultValue.defined(vertexFormat.normal)
        ? new Float32Array(3 * 4 * numberOfPlanes)
        : undefined;
      var tangents = defaultValue.defined(vertexFormat.tangent)
        ? new Float32Array(3 * 4 * numberOfPlanes)
        : undefined;
      var bitangents = defaultValue.defined(vertexFormat.bitangent)
        ? new Float32Array(3 * 4 * numberOfPlanes)
        : undefined;
      var st = defaultValue.defined(vertexFormat.st)
...
//# sourceMappingURL=FrustumGeometry-60e3a35e.js.map
