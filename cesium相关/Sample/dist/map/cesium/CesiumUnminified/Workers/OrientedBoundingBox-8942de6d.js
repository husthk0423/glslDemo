...
define(['exports', './BoundingSphere-9136c54c', './Cartesian2-d1e6e2fc', './Check-edea0f91', './defaultValue-81eec7ed', './EllipsoidTangentPlane-15d9e91d', './Math-6392bd21', './Matrix4-e8df88c4', './Plane-abc450d6', './Rectangle-56d45148'], (function (exports, BoundingSphere, Cartesian2, Check, defaultValue, EllipsoidTangentPlane, _Math, Matrix4, Plane, Rectangle) { 'use strict';
  ...
  function OrientedBoundingBox(center, halfAxes) {
     ...
     */
    this.halfAxes = Matrix4.Matrix3.clone(defaultValue.defaultValue(halfAxes, Matrix4.Matrix3.ZERO));
  }
  ...
  OrientedBoundingBox.packedLength =
    Cartesian2.Cartesian3.packedLength + Matrix4.Matrix3.packedLength;
  ...
  OrientedBoundingBox.pack = function (value, array, startingIndex) {
    ...
    Matrix4.Matrix3.pack(value.halfAxes, array, startingIndex + Cartesian2.Cartesian3.packedLength);
  ...
  OrientedBoundingBox.fromPoints = function (positions, result) {
    ...
    var eigenDecomposition = Matrix4.Matrix3.computeEigenDecomposition(
      covarianceMatrix,
      scratchEigenResult
    );
  ...
  OrientedBoundingBox.fromRectangle = function (
    ...
    if (rectangle.width <= _Math.CesiumMath.PI) {
      ...
      var tangentPointCartographic = Rectangle.Rectangle.center(
        rectangle,
    ...
    var latitudeNearestToEquator = fullyAboveEquator
      ...
      ? rectangle.north
      : 0.0;
    var centerLongitude = Rectangle.Rectangle.center(
      rectangle,
      scratchRectangleCenterCartographic
    ).longitude;
  ...
  OrientedBoundingBox.intersectPlane = function (box, plane) {
    ...
    var radEffective =
      Math.abs(
        normalX * halfAxes[Matrix4.Matrix3.COLUMN0ROW0] +
          normalY * halfAxes[Matrix4.Matrix3.COLUMN0ROW1] +
          normalZ * halfAxes[Matrix4.Matrix3.COLUMN0ROW2]
      ) +
      Math.abs(
        normalX * halfAxes[Matrix4.Matrix3.COLUMN1ROW0] +
          normalY * halfAxes[Matrix4.Matrix3.COLUMN1ROW1] +
          normalZ * halfAxes[Matrix4.Matrix3.COLUMN1ROW2]
      ) +
      Math.abs(
        normalX * halfAxes[Matrix4.Matrix3.COLUMN2ROW0] +
          normalY * halfAxes[Matrix4.Matrix3.COLUMN2ROW1] +
          normalZ * halfAxes[Matrix4.Matrix3.COLUMN2ROW2]
      );
  ...
  OrientedBoundingBox.isOccluded = function (box, occluder) {
    ...
    var sphere = BoundingSphere.BoundingSphere.fromOrientedBoundingBox(
      box,
...
//# sourceMappingURL=OrientedBoundingBox-8942de6d.js.map
