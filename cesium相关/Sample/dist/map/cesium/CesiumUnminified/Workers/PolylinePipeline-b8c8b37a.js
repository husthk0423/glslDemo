...
define(['exports', './Cartesian2-d1e6e2fc', './defaultValue-81eec7ed', './Check-edea0f91', './EllipsoidGeodesic-362d0fb4', './EllipsoidRhumbLine-f9c31bdb', './IntersectionTests-ad64d6a6', './Math-6392bd21', './Matrix4-e8df88c4', './Plane-abc450d6'], (function (exports, Cartesian2, defaultValue, Check, EllipsoidGeodesic, EllipsoidRhumbLine, IntersectionTests, _Math, Matrix4, Plane) { 'use strict';
  ...
  PolylinePipeline.wrapLongitude = function (positions, modelMatrix) {
    ...
    if (defaultValue.defined(positions) && positions.length > 0) {
      modelMatrix = defaultValue.defaultValue(modelMatrix, Matrix4.Matrix4.IDENTITY);
      var inverseModelMatrix = Matrix4.Matrix4.inverseTransformation(
        modelMatrix,
        wrapLongitudeInversMatrix
      );

      var origin = Matrix4.Matrix4.multiplyByPoint(
        inverseModelMatrix,
        Cartesian2.Cartesian3.ZERO,
        wrapLongitudeOrigin
      );
      var xzNormal = Cartesian2.Cartesian3.normalize(
        Matrix4.Matrix4.multiplyByPointAsVector(
          inverseModelMatrix,
...
//# sourceMappingURL=PolylinePipeline-b8c8b37a.js.map
