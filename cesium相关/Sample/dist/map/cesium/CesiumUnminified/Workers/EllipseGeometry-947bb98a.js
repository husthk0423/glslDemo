...
define(['exports', './GeometryOffsetAttribute-a397674c', './BoundingSphere-9136c54c', './Cartesian2-d1e6e2fc', './Check-edea0f91', './ComponentDatatype-a4840ad0', './defaultValue-81eec7ed', './EllipseGeometryLibrary-d426a96a', './GeographicProjection-2244ffb1', './GeometryAttribute-e5d56fca', './GeometryAttributes-32b29525', './GeometryInstance-6a4043b0', './GeometryPipeline-517da8b1', './IndexDatatype-67a127c0', './Math-6392bd21', './Matrix4-e8df88c4', './Transforms-720cb02d', './Rectangle-56d45148', './VertexFormat-e098f487'], (function (exports, GeometryOffsetAttribute, BoundingSphere, Cartesian2, Check, ComponentDatatype, defaultValue, EllipseGeometryLibrary, GeographicProjection, GeometryAttribute, GeometryAttributes, GeometryInstance, GeometryPipeline, IndexDatatype, _Math, Matrix4, Transforms, Rectangle, VertexFormat) { 'use strict';
  ...
  function computeTopBottomAttributes(positions, options, extrude) {
    ...
    for (var i = 0; i < length; i += 3) {
      ...
      if (vertexFormat.st) {
        var rotatedPoint = Matrix4.Matrix3.multiplyByVector(
          textureMatrix,
          position,
          scratchCartesian2
        );
  ...
  function computeEllipse(options) {
    ...
    var boundingSphere = new BoundingSphere.BoundingSphere(
      boundingSphereCenter,
  ...
  function computeExtrudedEllipse(options) {
    ...
    var boundingSphere = BoundingSphere.BoundingSphere.union(
      topBoundingSphere,
...
//# sourceMappingURL=EllipseGeometry-947bb98a.js.map
