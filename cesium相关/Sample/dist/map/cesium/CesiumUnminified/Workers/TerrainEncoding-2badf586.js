...
define(['exports', './BoundingSphere-9136c54c', './Cartesian2-d1e6e2fc', './Check-edea0f91', './defaultValue-81eec7ed', './Rectangle-56d45148', './AttributeCompression-90a6f055', './ComponentDatatype-a4840ad0', './Math-6392bd21', './Matrix4-e8df88c4'], (function (exports, BoundingSphere, Cartesian2, Check, defaultValue, Rectangle, AttributeCompression, ComponentDatatype, _Math, Matrix4) { 'use strict';
  ...
  EllipsoidalOccluder.prototype.computeHorizonCullingPointFromRectangle = function (
    ...
    var positions = Rectangle.Rectangle.subsample(
      rectangle,
      ellipsoid,
      0.0,
      subsampleScratch
  ...
  function TerrainEncoding(
    ...
    if (
      ...
      Matrix4.Matrix4.multiply(
        Matrix4.Matrix4.fromTranslation(translation, matrix4Scratch),
        toENU,
        toENU
      );
      ...
      Matrix4.Matrix4.setTranslation(matrix, Cartesian2.Cartesian3.ZERO, matrix);
  ...
  TerrainEncoding.prototype.encode = function (
    ...
    if (this.quantization === TerrainQuantization$1.BITS12) {
      position = Matrix4.Matrix4.multiplyByPoint(
        this.toScaledENU,
        position,
        cartesian3Scratch
      );
...
//# sourceMappingURL=TerrainEncoding-2badf586.js.map
