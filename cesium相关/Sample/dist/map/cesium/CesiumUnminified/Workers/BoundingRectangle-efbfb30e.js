...
define(['exports', './Cartesian2-d1e6e2fc', './Check-edea0f91', './defaultValue-81eec7ed', './GeographicProjection-2244ffb1', './BoundingSphere-9136c54c', './Rectangle-56d45148'], (function (exports, Cartesian2, Check, defaultValue, GeographicProjection, BoundingSphere, Rectangle) { 'use strict';
  ...
  BoundingRectangle.fromRectangle = function (rectangle, projection, result) {
    ...
    var lowerLeft = projection.project(
      Rectangle.Rectangle.southwest(rectangle, fromRectangleLowerLeft)
    );
    var upperRight = projection.project(
      Rectangle.Rectangle.northeast(rectangle, fromRectangleUpperRight)
    );
...
//# sourceMappingURL=BoundingRectangle-efbfb30e.js.map
