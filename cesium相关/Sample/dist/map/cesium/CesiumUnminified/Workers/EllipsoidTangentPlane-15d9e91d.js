...
define(['exports', './AxisAlignedBoundingBox-20a5bd54', './Cartesian2-d1e6e2fc', './Matrix4-e8df88c4', './Check-edea0f91', './defaultValue-81eec7ed', './IntersectionTests-ad64d6a6', './Plane-abc450d6', './Transforms-720cb02d'], (function (exports, AxisAlignedBoundingBox, Cartesian2, Matrix4, Check, defaultValue, IntersectionTests, Plane, Transforms) { 'use strict';
  ...
  function EllipsoidTangentPlane(origin, ellipsoid) {
    ...
    this._xAxis = Cartesian2.Cartesian3.fromCartesian4(
      Matrix4.Matrix4.getColumn(eastNorthUp, 0, scratchCart4)
    );
    this._yAxis = Cartesian2.Cartesian3.fromCartesian4(
      Matrix4.Matrix4.getColumn(eastNorthUp, 1, scratchCart4)
    );

    var normal = Cartesian2.Cartesian3.fromCartesian4(
      Matrix4.Matrix4.getColumn(eastNorthUp, 2, scratchCart4)
    );
...
//# sourceMappingURL=EllipsoidTangentPlane-15d9e91d.js.map
