...
define(['exports', './Cartesian2-d1e6e2fc', './Matrix4-e8df88c4', './EllipsoidTangentPlane-15d9e91d', './Math-6392bd21', './PolylinePipeline-b8c8b37a', './Transforms-720cb02d', './defaultValue-81eec7ed', './Check-edea0f91'], (function (exports, Cartesian2, Matrix4, EllipsoidTangentPlane, _Math, PolylinePipeline, Transforms, defaultValue, Check) { 'use strict';
  ...
  function addPosition(
    ...
    transform = Matrix4.Matrix4.multiplyTransformation(
      transform,
      Matrix4.Matrix4.fromRotationTranslation(rotationZ, heightCartesian, translation),
      transform
    );
    ...
    for (var j = 0; j < repeat; j++) {
      for (var i = 0; i < shape.length; i += 3) {
        ...
        finalPosition = Matrix4.Matrix3.multiplyByVector(
          scale,
          finalPosition,
          finalPosition
        );
        finalPosition = Matrix4.Matrix4.multiplyByPoint(
          transform,
          finalPosition,
          finalPosition
        );
  ...
  function computeRoundCorner(
    ...
    var m;
    if (leftIsOutside) {
      m = Matrix4.Matrix3.fromQuaternion(
...
//# sourceMappingURL=PolylineVolumeGeometryLibrary-1b569bb7.js.map
