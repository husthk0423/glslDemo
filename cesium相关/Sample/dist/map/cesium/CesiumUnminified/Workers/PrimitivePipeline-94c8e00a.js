...
define(['exports', './BoundingSphere-8e46fc6d', './ComponentDatatype-c3776840', './defaultValue-e27640a4', './Check-1d0ca1d6', './Cartesian2-30a7929d', './GeographicProjection-ad0e20b7', './GeometryAttribute-122cccb9', './GeometryAttributes-42f6198b', './GeometryPipeline-aabfa393', './IndexDatatype-87e5aa85', './Transforms-8def6431', './WebMercatorProjection-95f96a19'], (function (exports, BoundingSphere, ComponentDatatype, defaultValue, Check, Cartesian2, GeographicProjection, GeometryAttribute, GeometryAttributes, GeometryPipeline, IndexDatatype, Transforms, WebMercatorProjection) { 'use strict';
    ...
    function transformToWorldCoordinates(instances, primitiveModelMatrix, scene3DOnly) {
        ...
        function geometryPipeline(parameters) {
            ...
            //>>includeStart('debug', pragmas.debug);
            for (i = 1; i < length; ++i) {
                if (defaultValue.defined(instances[i].geometry) && instances[i].geometry.primitiveType !== primitiveType) {
        ...
        PrimitivePipeline.combineGeometry = function(parameters) {
            ...
            if (length > 0) {
                ...
                if (defaultValue.defined(instances[0].attributes) && defaultValue.defined(instances[0].attributes.offset)) {
            ...
            for (var i = 0; i < length; ++i) {
                ...
                if (defaultValue.defined(eastHemisphereGeometry) && defaultValue.defined(westHemisphereGeometry)) {
                    if (defaultValue.defined(eastHemisphereGeometry.boundingSphere) && defaultValue.defined(westHemisphereGeometry.boundingSphere)) {
                    ...
                    if (defaultValue.defined(eastHemisphereGeometry.boundingSphereCV) && defaultValue.defined(westHemisphereGeometry.boundingSphereCV)) {
        ...
        function countCreateGeometryResults(items) {
            ...
            for (var i = 0; i < length; i++) {
                ...
                count += 7 + 2 * BoundingSphere.BoundingSphere.packedLength + (defaultValue.defined(geometry.indices) ? geometry.indices.length : 0);

                for (var property in attributes) {
                    if (attributes.hasOwnProperty(property) && defaultValue.defined(attributes[property])) {
        ...
        PrimitivePipeline.packCreateGeometryResults = function(items, transferableObjects) {
            ...
            for (var i = 0; i < length; i++) {
                ...
                var validGeometry = defaultValue.defined(geometry);
                ...
                var validBoundingSphere = defaultValue.defined(geometry.boundingSphere) ? 1.0 : 0.0;
                ...
                var validBoundingSphereCV = defaultValue.defined(geometry.boundingSphereCV) ? 1.0 : 0.0;
                ...
                var indicesLength = defaultValue.defined(geometry.indices) ? geometry.indices.length : 0;
        ...
        PrimitivePipeline.unpackCombineGeometryParameters = function(packedParameters) {
            ...
            var projection = packedParameters.isGeographic ? new GeographicProjection.GeographicProjection(ellipsoid) : new WebMercatorProjection.WebMercatorProjection(ellipsoid);
...
//# sourceMappingURL=PrimitivePipeline-94c8e00a.js.map
