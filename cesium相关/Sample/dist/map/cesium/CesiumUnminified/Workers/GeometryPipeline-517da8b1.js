...
define(['exports', './AttributeCompression-90a6f055', './Cartesian2-d1e6e2fc', './Check-edea0f91', './defaultValue-81eec7ed', './Math-6392bd21', './BoundingSphere-9136c54c', './Matrix4-e8df88c4', './ComponentDatatype-a4840ad0', './EncodedCartesian3-a1d56877', './GeographicProjection-2244ffb1', './GeometryAttribute-e5d56fca', './IndexDatatype-67a127c0', './IntersectionTests-ad64d6a6', './Plane-abc450d6'], (function (exports, AttributeCompression, Cartesian2, Check, defaultValue, _Math, BoundingSphere, Matrix4, ComponentDatatype, EncodedCartesian3, GeographicProjection, GeometryAttribute, IndexDatatype, IntersectionTests, Plane) { 'use strict';
  ...
  function transformPoint(matrix, attribute) {
    if (defaultValue.defined(attribute)) {
      ...
      for (var i = 0; i < length; i += 3) {
        ...
        Matrix4.Matrix4.multiplyByPoint(matrix, scratchCartesian3, scratchCartesian3);
  ...
  function transformVector(matrix, attribute) {
    if (defaultValue.defined(attribute)) {
      ...
      for (var i = 0; i < length; i += 3) {
        Cartesian2.Cartesian3.unpack(values, i, scratchCartesian3);
        Matrix4.Matrix3.multiplyByVector(matrix, scratchCartesian3, scratchCartesian3);
  ...
  GeometryPipeline.transformToWorldCoordinates = function (instance) {
    ...
    if (defaultValue.defined(boundingSphere)) {
      instance.geometry.boundingSphere = BoundingSphere.BoundingSphere.transform(
        boundingSphere,
        modelMatrix,
        boundingSphere
      );
  ...
  function combineGeometries(instances, propertyName) {
    ...
    return new GeometryAttribute.Geometry({
      ...
      boundingSphere: defaultValue.defined(center)
        ? new BoundingSphere.BoundingSphere(center, radius)
        : undefined,
    });
  }
  ...
  function updateGeometryAfterSplit(geometry, computeBoundingSphere) {
    ...
    if (computeBoundingSphere) {
      geometry.boundingSphere = BoundingSphere.BoundingSphere.fromVertices(
  ...
  function splitLongitudeTriangles(instance) {
    ...
    var normals = defaultValue.defined(attributes.normal)
      ? attributes.normal.values
      : undefined;
    var bitangents = defaultValue.defined(attributes.bitangent)
      ? attributes.bitangent.values
      : undefined;
    var tangents = defaultValue.defined(attributes.tangent)
      ? attributes.tangent.values
      : undefined;
    var texCoords = defaultValue.defined(attributes.st) ? attributes.st.values : undefined;
    var extrudeDirections = defaultValue.defined(attributes.extrudeDirection)
      ? attributes.extrudeDirection.values
      : undefined;
    var applyOffset = defaultValue.defined(attributes.applyOffset)
  ...
  GeometryPipeline.splitLongitude = function (instance) {
    ...
    if (defaultValue.defined(boundingSphere)) {
      ...
      if (
        minX > 0 ||
        BoundingSphere.BoundingSphere.intersectPlane(boundingSphere, Plane.Plane.ORIGIN_ZX_PLANE) !==
          BoundingSphere.Intersect.INTERSECTING
      ) {
        return instance;
      }
    }
...
//# sourceMappingURL=GeometryPipeline-517da8b1.js.map
