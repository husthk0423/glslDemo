...
define(['exports', './BoundingSphere-9136c54c', './ComponentDatatype-a4840ad0', './defaultValue-81eec7ed', './Check-edea0f91', './Cartesian2-d1e6e2fc', './GeographicProjection-2244ffb1', './GeometryAttribute-e5d56fca', './GeometryAttributes-32b29525', './GeometryPipeline-517da8b1', './IndexDatatype-67a127c0', './Matrix4-e8df88c4', './WebMercatorProjection-2efde0c0'], (function (exports, BoundingSphere, ComponentDatatype, defaultValue, Check, Cartesian2, GeographicProjection, GeometryAttribute, GeometryAttributes, GeometryPipeline, IndexDatatype, Matrix4, WebMercatorProjection) { 'use strict';
        ...
        for (name in attributes) {
          if (
            ...
            if (defaultValue.defined(geometry.boundingSphere) && name === "position") {
              geometry.boundingSphereCV = BoundingSphere.BoundingSphere.fromVertices(
    ...
    for (var i = 0; i < length; ++i) {
      ...
      if (defaultValue.defined(eastHemisphereGeometry) && defaultValue.defined(westHemisphereGeometry)) {
        if (
          ...
          boundingSpheres[i] = BoundingSphere.BoundingSphere.union(
        ...
        if (
          ...
          boundingSpheresCV[i] = BoundingSphere.BoundingSphere.union(
  ...
  function countCreateGeometryResults(items) {
    ...
    for (var i = 0; i < length; i++) {
      ...
      count +=
        7 +
        2 * BoundingSphere.BoundingSphere.packedLength +
  ...
  PrimitivePipeline.unpackCreateGeometryResults = function (
    ...
    while (packedGeometryIndex < packedGeometry.length) {
      ...
      if (validBoundingSphere) {
        boundingSphere = BoundingSphere.BoundingSphere.unpack(
          packedGeometry,
          packedGeometryIndex
        );
      }
      ...
      if (validBoundingSphereCV) {
        boundingSphereCV = BoundingSphere.BoundingSphere.unpack(
          packedGeometry,
          packedGeometryIndex
        );
      }
...
//# sourceMappingURL=PrimitivePipeline-ae27295e.js.map
